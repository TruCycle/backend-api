...
export class ShopsController {
  ...
  @ApiCreatedResponse({ description: 'Shop created', schema: { example: { id: 'uuid', name: 'Shop A', address_line: '1 High St', postcode: 'AB12 3CD', latitude: 51.5, longitude: -0.12, active: true } } })
